...
export const projects: Project[] = [
  {
    ...
    title: "My Portfolio",
    description:
      "Modern portfolio website built with Next.js 14, featuring server components, beautiful animations, and a responsive design.",
    image: "/projects/4.webp",
    tech: ["nextjs", "react", "farmermotion", "typescript", "tailwind"],
    live: "https://my-portfolio-orcin-eta-32.vercel.app/",
    date: "2025-02-07",
    features: [
  ...
  },
  {
    ...
    description:
      "A comprehensive web application for pharmacy management, enabling inventory tracking, sales monitoring, and detailed reporting. It provides an intuitive dashboard to enhance daily operations and efficiency.",
  ...
  },
  {
    ...
    title: "React Blog",
    description:
      "A modern and responsive blogging platform built with React, featuring a dynamic user interface, content management, and seamless navigation.",
  ...
  },
  {
    ...
    description:
      "A sleek and modern portfolio website built with Next.js and Tailwind CSS, designed to showcase projects, skills, and achievements in an engaging and professional manner.",
  ...
  },
  {
    ...
    description:
      "A full-stack multilingual restaurant website built with Next.js and PostgreSQL, offering an intuitive online ordering system, menu management, and a seamless customer experience.",
